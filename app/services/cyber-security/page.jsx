...
// Move the SVG background string out of the JSX to prevent Turbopack compilation errors
      ...
      <main style={{ fontFamily: "'Segoe UI', sans-serif", color: "#1a1a2e" }}>
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", gap: 24, alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "#555", lineHeight: 1.7, margin: "0 0 10px" }}>
                From ransomware attacks to data breaches and AI-driven threats, businesses today face continuous cyber risk.
              </p>
              <p style={{ fontSize: 15, color: "#555", lineHeight: 1.7, margin: "0 0 10px" }}>
                A single incident can lead to data loss, downtime, and financial damage.
              </p>
              <p style={{ fontSize: 15, color: "#555", lineHeight: 1.7, margin: 0 }}>
                At <strong>THE CYBERTECH</strong>, we help you protect, detect, and respond with a structured, business-focused cybersecurity approach.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ background: "#eef1f8", padding: "70px 24px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <p style={{ textAlign: "center", color: "#555", marginBottom: 36, fontSize: 15 }}>You should take action if:</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 20, marginBottom: 30 }}>
              {[
                { icon: "🔒", text: "You are unsure about your current security posture" },
                { icon: "👁️", text: "You’ve noticed suspicious system activity" },
                { icon: "📄", text: "You are adopting cloud or AI technologies" },
                { icon: "💻", text: "You want to proactively prevent cyber attacks" },
              ].map((item, i) => (
                <div key={i} style={{
        ...
        <section style={{ background: "#fff", padding: "70px 24px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 24 }}>
              {[
                { icon: "🧠", title: "Threat & Risk Assessment", items: ["Identify vulnerabilities", "Evaluate exposure points", "Define security gaps"] },
                { icon: "🛡️", title: "Security Strategy & Architecture", items: ["Design secure infrastructure", "Align security with business growth", "Build scalable protection frameworks"] },
                { icon: "🚨", title: "Incident Response & Recovery", items: ["Immediate threat containment", "System stabilization", "Recovery from cyber attacks"] },
                { icon: "💾", title: "Data Protection & Backup", items: ["Secure critical data", "Implement recovery strategies", "Prevent data loss"] },
                { icon: "⚖️", title: "Compliance & Governance", items: ["Align with regulatory standards", "Prepare for audits", "Ensure policy-driven security"] },
                { icon: "🤖", title: "AI & Cyber Risk Advisory", items: ["Secure AI usage", "Prevent data leakage", "Manage AI-driven threats"] },
              ].map((card, i) => (
                <div key={i} style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 24 }}>
              {[
                ...
                { icon: "✔", stat: "Real-world", label: "Cyber incident handling expertise", sub: "Live Incident Management" },
                { icon: "✔", stat: "Strategy-first", label: "Consulting approach", sub: "Tactical Planning" },
                { icon: "✔", stat: "Business-focused", label: "Security solutions", sub: "Operational Integrity" },
                { icon: "✔", stat: "Confidential", label: "And trusted engagement", sub: "Absolute Protection" },
              ].map((item, i) => (
                <div key={i} style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 20 }}>
              {[
                ...
                "Organizations adopting cloud or AI",
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: "#90caf9", margin: "0 0 18px" }}>
                Don’t Wait for an Attack to Act
              </p>
            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              ...
              >Request a Cybersecurity Assessment</a>
              <a href="/contact" style={{
                display: "inline-block", padding: "14px 28px", borderRadius: 8,
                fontSize: 15, fontWeight: 600, textDecoration: "none",
        ...
        <section style={{ background: "#0d1b3e", padding: "70px 24px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <blockquote style={{
              ...
              “Cybersecurity is not a product — it’s a continuous discipline.”
            </blockquote>
            <div style={{ textAlign: "center", color: "#90caf9" }}>
              ...
              <span style={{ fontSize: 13 }}>Cybersecurity | Cyber Forensics | Data Center Consulting — THE CYBERTECH</span>
            </div>
          </div>
        </section>
